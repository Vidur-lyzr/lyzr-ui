...
+            <div className="w-16 h-16 bg-gradient-to-r from-[#603BFC] to-[#A94FA1] rounded-xl flex items-center justify-center">
+              <Search className="w-8 h-8 text-white" />
+            </div>
+            <h1 className="text-6xl font-bold bg-gradient-to-r from-[#603BFC] to-[#A94FA1] bg-clip-text text-transparent">
+              Lyzr AI
+            </h1>
+          </div>
+          
+          <p className="text-2xl text-muted-foreground mb-12 leading-relaxed">
+            Discover the perfect AI agent for your business needs. 
+            <br />
+            Explore our comprehensive library of production-ready agents.
+          </p>
+          
